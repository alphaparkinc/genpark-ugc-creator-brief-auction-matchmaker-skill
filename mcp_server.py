                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Influencer Marketing skill operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Influencer Skill executed successfully."})
                    }
                ]
            }
        }
