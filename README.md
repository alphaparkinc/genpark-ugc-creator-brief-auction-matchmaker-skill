# genpark-ugc-creator-brief-auction-matchmaker-skill
...
**genpark-ugc-creator-brief-auction-matchmaker-skill** is a deterministic, zero-dependency Python skill engineered for autonomous creator operations, influencer marketing automation, and multi-agent campaign workflows.

> **Executive Capability**: UGC creator brief programmatic auction & video matchmaking (Cohley)
...
result = client.match_ugc_creators_for_brief()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-ugc-creator-brief-auction-matchmaker-skill": {
      "command": "python",
      "args": ["/path/to/genpark-ugc-creator-brief-auction-matchmaker-skill/mcp_server.py"]
    }
  }
}
```
